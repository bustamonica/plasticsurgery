...
- sixsurgery publishes every photo with opaque circles censoring the nipples. The pairs validate fine but training on them would teach the artifact, so they are deliberately not emitted pending a captain ruling.
