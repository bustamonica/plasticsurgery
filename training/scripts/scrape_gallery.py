...
def split_composite_image(data: bytes, bottom_crop: int = 0,
    ...
    if seam_trim:
        ...
        boxes = ((0, 0, half, bottom), (half, 0, img.width, bottom))
    out = []
    for box in boxes:
        buf = io.BytesIO()
